...
| :--- | :---: | :--- | :---: |
| 🎟️ Initial Access | **`1`** | 📡 Discovery | `0` |
| 🚀 Execution | **`9`** | 🏃 Lateral Movement | **`4`** |
| ⚓ Persistence | **`8`** | 📦 Collection | **`1`** |
| 📈 Privilege Escalation | **`2`** | 🚩 Command and Control | **`2`** |
| 🛡️ Defense Evasion | **`10`** | 📤 Exfiltration | `0` |
...
## 🎟️ Initial Access
| Technique ID | Title | Lead Name |
| :--- | :--- | :--- |
| [T1566](https://attack.mitre.org/techniques/T1566/) | Phishing | [Possible FileFix Attack](Leads/Execution/Possible-FileFix-Attack.md) |
