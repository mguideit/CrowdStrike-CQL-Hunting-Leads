...
#### Technical Risk
Allows persistent execution of malicious code as a background service, often with SYSTEM-level privileges.
...
#### Tags
`#Hunting` `#Persistence` `#Falcon` `#CQL`
...
| format("[https://falcon.us-2.crowdstrike.com/graphs/process-explorer/tree?id=pid:%25s:%25s&investigate=true&_cid=%25s](https://falcon.us-2.crowdstrike.com/graphs/process-explorer/tree?id=pid:%25s:%25s&investigate=true&_cid=%25s)", field=["aid","RpcClientProcessId","cid"], as="Tree")
| join(
query={
